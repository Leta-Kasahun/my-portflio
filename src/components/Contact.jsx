...
export default function Contact({ darkMode }) {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_g68d2y5", // your service ID
        "template_10y17mg", // your template ID
        {
          user_email: formData.email, // must match your template {{user_email}}
          message: formData.message,  // must match your template {{message}}
          subject: `Message from ${formData.name}`, // fits {{subject}} in your template
        },
        "Md2MhkOiuS-FL7APG" // your public key
      )
      .then(
        (result) => {
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="mt-6 flex flex-col gap-4 text-base">
            ...
            <div className="flex items-center gap-3">
              <FaMapMarkerAlt
                className={`${
                  darkMode ? "text-coral-400" : "text-red-500"
                } text-xl`}
              />
